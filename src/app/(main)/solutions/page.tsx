...
const solutions = [
  ...
  },
  {
    ...
    description:
      "We design practical AI capabilities for real business operations, from website and app copilots to WhatsApp AI support assistants.",
    features: [
      "AI integration into websites and business applications",
      "Custom AI assistant build, tuning, and team enablement",
      "WhatsApp AI support flows powered by OpenClaw",
      "Knowledge-base grounded responses for client support",
      "Process automation with human-approval checkpoints",
    ],
    icon: Cpu,
          ...
          {solutions.map((solution, index) => (
            ...
            >
              <div className="flex-1">
                ...
                <p className="text-lg leading-8 text-muted-foreground mb-8">{solution.description}</p>
